...
import com.huawei.spider.center.beans.BitTorrentInfo;
import com.huawei.spider.center.beans.Files;
import com.huawei.spider.center.beans.Info;
...
public class BitTorrents {
    ...
    public static void main(String[] args) throws Exception {
        String url = "/mydoc/Silencer.torrent";
//        String url = "E://xx/xx.torrent";

        BitTorrentInfo info = parse(url);
